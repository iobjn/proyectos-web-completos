...
<div class="container pb-4 pt-4">
                ...
                <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                    ...
                    <tbody>
                        ...
                        <tr class="has-text-centered" >
                            ...
                            <td>
                                <button type="button" class="button is-success is-rounded is-small js-modal-trigger" data-target="modal-js-price" onclick="modal_actualizar_precio('<?php echo $productos['venta_detalle_descripcion']; ?>','<?php echo $productos['producto_codigo']; ?>','<?php echo $productos['venta_detalle_precio_venta']; ?>')" >
    ...
    <?php }else{ ?>
        <article class="message is-warning">
            ...
            <div class="message-body has-text-centered"><i class="fas fa-exclamation-triangle fa-2x"></i><br>No hemos podio seleccionar algunos datos sobre la empresa<?php if($_SESSION['cargo']=="Administrador"){ ?>, por favor <a href="<?php echo APP_URL; ?>companyNew/" >verifique aquí los datos de la empresa<?php } ?></div>
        </article>
    <?php } ?>
</div>
