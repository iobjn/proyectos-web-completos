...
// require_once ("clsspagos.php");
 ...
 $objEmpleado -> setPuesto("tester");
 $objEmpleado -> setMensaje("Desarrollado del proyecto por: ");
...
$objCliente -> setMensaje("Adquirido por: cliente de paso :");
$objCliente -> setMensajeName("Ernesto");
echo "<br>".">>>" . $objCliente -> getMensaje();
echo $objCliente -> getDatosPersonales();
echo "Credito:". $objCliente -> getCredito();
echo "<br>"."Cliente: " . $objCliente -> getMensaje();
echo "<br>"."Cliente Registro: " . $objCliente -> getMensajeName();
